...
NDiplomacy = {
	...
	PEACE_COST_DEMAND_PROVINCE = 0.00001,					-- Demand a province (scales by province wealth, also used for annex)
	PEACE_COST_CONCEDE_PROVINCE = 0.0001,				-- Demand colonial area province concession.
	PEACE_COST_BECOME_VASSAL = 0.00001,					-- Vassalize a country (scales by province wealth)
	PEACE_COST_PILLAGE_CAPITAL = 1,					-- Pillage a capital state's dev (scales by province wealth)
	PEACE_COST_RETURN_CORE = 0.00001,						-- Return a core (scales by province wealth)
	PEACE_COST_REVOKE_CORE = 0.0001,						-- Revoke a core (scales by province wealth)
	PEACE_COST_RELEASE_ANNEXED = 0.0001,					-- Release annexed nation (scales by province wealth)
	PEACE_COST_RELEASE_VASSAL = 0.0001,					-- Release vassal (scales by province wealth)
	PEACE_COST_REVOKE_ELECTOR = 0.0001,					-- Revoke an elector title
	PEACE_COST_UNION = 0.00001, 							-- _DDEF_PEACE_COST_UNION_ Peace cost for forming a personal union
	PEACE_COST_SUBJUGATE = 0.00001, 							-- Peace cost for subjugating an enemy using the subjugation CB
	PEACE_COST_JOIN_HRE = 0.0001, 							-- Max Peace cost for forcing country to join the empire
	PEACE_COST_CONVERSION = 0.0008,					-- scaled with countrysize for forced conversion in peace.
	PEACE_COST_CONCEDE = 0.0001, 						-- _DDEF_PEACE_COST_CONCEDE_ Base Peace cost for conceding defeat
	PEACE_COST_GOLD_STEP = 0.001, 						-- _DDEF_PEACE_COST_GOLD_STEP_ Peace Cost for 1 loan size gold of giver
	PEACE_COST_GOLD_MAX = 0.0001,						-- Maximum loans of gold that can be demanded from giver in peace.
	PEACE_COST_ANNUL = 0.00001, 							-- _DDEF_PEACE_COST_ANNUL_ Peace cost for annulment of treaties
	PEACE_COST_CHANGE_GOVERNMENT = 0.0001, 				-- _Peace cost for changing government form
	PEACE_COST_TRADE_POWER = 0.0001, 					-- Peace cost for demanding trade power
	PEACE_COST_STEER_TRADE = 0.0001,					-- Peace cost for steering trade
	PEACE_COST_INDEPENDANCE = 0.0001, 					-- Peace cost for breaking free of union
	PEACE_COST_ENFORCED_FLEET_BASING_RIGHTS = 0.0005,   -- Peace cost for enforced fleet basing righs
	PEACE_COST_ENFORCED_MILITARY_ACCESS = 0.0005,       -- Peace cost for enforced military access
	PEACE_COST_WAR_REPARATIONS = 0.0001,				-- Peace cost for war reparations
	PEACE_COST_GIVE_UP_CLAIM = 0.0001,					-- Peace cost for giving up all claims in a country
	PEACE_COST_DISMANTLE_REVOLUTION = 0.0001,
	PEACE_COST_CHANGE_HRE_RELIGION = 0.0001,
	PEACE_COST_HUMILIATE_RIVAL = 0.0001,
	PEACE_COST_FORCE_MIGRATION = 0.0001,
	PEACE_COST_FORCE_OUT_COLONIZERS = 0.0001,
	PEACE_COST_ENFORCE_REBEL_DEMANDS = 0.0001,
	PEACE_COST_END_RIVALRY = 0.0001,
	PEACE_COST_TAKE_MANDATE = 0.0001,
	PEACE_COST_SPREAD_REVOLUTION = 0.0001,
	MAX_PEACE_COST_TRIBUTARY_STATE = 0.0001,
